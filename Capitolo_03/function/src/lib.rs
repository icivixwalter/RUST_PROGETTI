 ...
 */
pub fn run() {
    let _y0 = 6; //ISTRUZIONE perche crei ed assegni una variabile con ; NON RITORNA VALORE
                // DA ERRORE: let _x = (let y = 6);    //errore NON SI PUO ASSEGNARE UNA ISTRUZIONE AD UN’ALTRA LA Y NON RITORNA IL VALORE

    /*ESPRESSIONE CORRETTA
     questa è una espressione corretta perche crea PRIMA UNA ISTRUZION con _x=3;. Il punto e virgola (;)
     la definisce come ISTRUZIONE.
    CREA UNA ESPRESSIONE con _x+1,
        incrementando la variabile _x e mancando il punto e virgola (;) permette IL RETURN DEL VALORE
    */

    let y = {
        //ESPRESSIONE DI Y CON LE {}
        let _x = 3;
        _x + 1
    };
    ...
    _x incrementata senza punto e virgola (;) per ottenere il valore di ritorno
    tipdo di espressione: let _x = 3; _x + 1 
    ...
    fn five() -> i32 {
        //definizione del parametro della funzione i32
        5 // con il valore da restituire (SENZA IL ;)
    }
    //Espressione con restituzione del valore ed assegnagmento alla variabile
    let _x = five(); // CHIAMATA DELLA FUNZIONE five per recuperare il valore di ritorno ed assegnarlo a _x
                    // come se avessi assegnato direttamente: let _x = 5; Inoltre la funzine five ()
    ...
    //===============================================================================================//
    {
        ...
        println!(
            ...
            ----------------------------------------------------------------------------
            la funzione chiamata restituisce il valore: - The value of _x is: {} \n",
            x2
        );
    }
