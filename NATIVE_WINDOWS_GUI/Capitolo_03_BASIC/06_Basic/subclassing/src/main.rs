...
/*Implementa il trait predefinito in modo che il controllo possa essere
 utilizzato da Windows native derive
I parametri sono: subclass_control! (tipo di utente, tipo di base, nome del campo di base)*/
//trait con 3 parametri
...
//STRUTTURA CustomButtonBuilder + IMPLEMENTAZIONE
//--------------------------------------------------------------------------------------//
...
//IMPLEMENTAZIONE SUB CLASS
impl SubclassApp {

    fn button_click1(&self) {
        nwg::modal_info_message(
        &self.window, 
        "01) Simple button", "Hey, I'm a simple button!
        Sono un semplice pulsante");
    }
    ...
    fn button_click2(&self) {
        ...
        Ciao, sono un pulsante con un tipo di utente def");
    }
    ...
    fn button_click3(&self, button: &CustomButton) {
        nwg::modal_info_message(
            &self.window, 
            "03) Custom button", 
            &format!("Hey, I'm a button with custom data! The data is
            Ehi, sono un pulsante con dati personalizzati! I dati sono {}!", button.data) );
    }
