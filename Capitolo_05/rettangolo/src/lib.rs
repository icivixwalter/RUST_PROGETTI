...
pub fn run() {
    ...
    // println!(" ");
    funzioni_calcolo_rettangolo::calcolo_rettangolo();
    ...
    println!(
        ...
        //area(width1, height1)
        funzioni_calcolo_rettangolo::area(width1, height1)
    );
    ...
    let rect2 = Rectangle {
        //run mantiene la proprieta dell’istanza di rect1
        width2: 30,
        height2: 50,
    };
