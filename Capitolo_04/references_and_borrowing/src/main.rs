...
fn main() {// main
    ...
    *NOTE: Oggetto con reference
    \n   
        ...
        println!("Il riferimento: The length of - len di s1: '{}' lunghezza di s1 è - is: {}.", reference_s1, reference_len);  
        ...
        
        {
           ...
           println!("RIFERIMENTO ALLA STRINGA MUTATO
...

        {
            ...
            *NOTE: II° ESEMPIO dove ha inizio e fine il riferimento e come puo essere utiizzato
            ...
            variabile r3 mutata : {}", r3); //qui viene inserito il riferimento mutabile
...
//-------------------------------------------------------------------------------------------//
    ...
    fn change(some_string:&mut String) {  //firma della funzione.
